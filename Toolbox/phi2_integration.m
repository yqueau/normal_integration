function [z,tab_nrj,tab_rmse] = phi2_integration(p,q,mask,lambda,z0,beta,gamma,maxit,tol,zinit,gt)
	...
	energie = norm(Lambda_two*(z(imask)-z0(imask)))+0.25*sum((norme_Dz_minus_g-gamma^2)./(norme_Dz_minus_g).^2)+0.25*sum((norme_Dz_minus_g2-gamma^2)./(norme_Dz_minus_g2).^2)+0.25*sum((norme_Dz_minus_g3-gamma^2)./(norme_Dz_minus_g3).^2)+0.25*sum((norme_Dz_minus_g4-gamma^2)./(norme_Dz_minus_g4).^2);
	...
	% Current energy
	f_curr = 0.25*sum((norme_Dz_minus_g-gamma^2)./(norme_Dz_minus_g).^2)+0.25*sum((norme_Dz_minus_g2-gamma^2)./(norme_Dz_minus_g2).^2)+0.25*sum((norme_Dz_minus_g3-gamma^2)./(norme_Dz_minus_g3).^2)+0.25*sum((norme_Dz_minus_g4-gamma^2)./(norme_Dz_minus_g4).^2);
	...
	for k = 1:maxit
		...
		% Current gradient
		Dz_minus_g = bsxfun(@rdivide,Dz_minus_g,norme_Dz_minus_g.^2);
		Dz_minus_g2 = bsxfun(@rdivide,Dz_minus_g2,norme_Dz_minus_g2.^2);
		...
		while(lc < max_backtracking)
			...
			f_next = 0.25*sum((norme_Dz_minus_g-gamma^2)./(norme_Dz_minus_g).^2)+0.25*sum((norme_Dz_minus_g2-gamma^2)./(norme_Dz_minus_g2).^2)+0.25*sum((norme_Dz_minus_g3-gamma^2)./(norme_Dz_minus_g3).^2)+0.25*sum((norme_Dz_minus_g4-gamma^2)./(norme_Dz_minus_g4).^2);
